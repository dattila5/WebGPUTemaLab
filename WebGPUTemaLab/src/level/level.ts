...
export const level1: GameObject[] = [
  ...
  { x: 1.2, y: -0.65, width: 1.6, height: 0.1, type: 'platform_grass', shape: 'quad', name: 'main1' },
  { x: 1.2, y: -0.875, width: 1.6, height: 0.35, type: 'platform_dirt', shape: 'quad', name: 'main1' },
  ...
  { x: 2.1, y: -0.3625, width: 0.05, height: 0.075, type: 'spike', shape: 'triangle', name: 'spiked_start_platform' },

  { x: 2.5, y: -0.35, width: 0.15, height: 0.1, type: 'platform_block', shape: 'quad', name: 'spike_end_platform' },
  { x: 2.55, y: -0.2625, width: 0.05, height: 0.075, type: 'spike', shape: 'triangle', name: 'spiked_end_platform' },

  { x: 2.75, y: -0.5, width: 0.2, height: 0.1, type: 'platform_block', shape: 'quad', name: 'spike_start_and_end_platform' },
  { x: 2.675, y: -0.4125, width: 0.05, height: 0.075, type: 'spike',  shape: 'triangle', name: 'spiked_end_platform' },
  { x: 2.825, y: -0.4125, width: 0.05, height: 0.075, type: 'spike', shape: 'triangle', name: 'spiked_end_platform' },

  { x: 3.75, y: -0.65, width: 1.5, height: 0.1, type: 'platform_grass', shape: 'quad', name: 'main2' },
  { x: 3.75, y: -0.875, width: 1.5, height: 0.35, type: 'platform_dirt', shape: 'quad', name: 'main2' },
