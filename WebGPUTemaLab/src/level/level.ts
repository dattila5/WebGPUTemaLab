...
export const level1: GameObject[] = [
  ...
  { x: 2.15, y: -0.45, width: 0.15, height: 0.1, type: 'platform_block', name: 'pike_start_platform' },
  { x: 2.5, y: -0.35, width: 0.15, height: 0.1, type: 'platform_block', name: 'pike_end_platform' },
  { x: 2.75, y: -0.5, width: 0.15, height: 0.1, type: 'platform_block', name: 'pike_start_and_end_platform' },
